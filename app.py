                ...
                with cols[col_idx]:
                    with st.container(border=True):
                        ...
                        with c2:
                            ...
                            if st.button("icon=:material/search:", key=f"edit_{row['Order ID']}", help="Edit in Sidebar", width='stretch'):
                                show_edit_dialog(row,row['Order ID']);
                                
                        with c3:
                            if st.button("icon=:material/delete:", key=f"del_{row['Order ID']}", help="Delete Order", width='stretch'):
